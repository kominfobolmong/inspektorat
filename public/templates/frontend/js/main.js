...
=============================================*/
    $(".portfolio__active").slick({
        ...
        slidesToScroll: 1,
        prevArrow:
            '<button class="slick-prev"><i class="far fa-long-arrow-alt-left"></i></button>',
        nextArrow:
            '<button class="slick-next"><i class="far fa-long-arrow-alt-right"></i></button>',
        responsive: [
            {
                breakpoint: 1200,
                settings: {
...
=============================================*/
    $(".testimonial__active").slick({
        ...
        slidesToScroll: 1,
        prevArrow:
            '<button class="slick-prev"><i class="far fa-long-arrow-left"></i></button>',
        nextArrow:
            '<button class="slick-next"><i class="far fa-long-arrow-right"></i></button>',
