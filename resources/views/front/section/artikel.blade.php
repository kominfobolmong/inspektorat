<section class="blog">
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog__post__item">
                    ...
                    <div class="blog__post__content">
                        ...
                        <h3 class="title"><a href="{{ route('news-detail', $item->slug) }}">{{ Str::limit(Str::title($item->title), 100, '...') }}</a></h3>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="blog__button text-center">
            <a href="{{ route('news') }}" class="btn">Lihat Lainnya</a>
        </div>
    </div>
</section>
