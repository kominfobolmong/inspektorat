...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('templates/home/logo-inspektorat.png') }}" rel="shortcut icon" type="image/x-icon">
  <link href="{{ asset('templates/home/logo-inspektorat.png') }}" rel="shortcut icon" type="image/x-icon">
...
<body>
  ...
  {{-- <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <a href="index.html" class="logo me-auto me-lg-0"><img src="{{ asset('templates/home/img/logo.png') }}" alt="" class="img-fluid"></a>
